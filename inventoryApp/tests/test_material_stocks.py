...
class MaterialStockDetailAPIViewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.material_stock = factories.MaterialStockFactory(store=self.store, material=self.material_quantity.ingredient, current_capacity=500, max_capacity=1000)
...
class MaterialStockListAPIViewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.material_quantity = factories.MaterialQuantityFactory(ingredient=self.material1)
        self.product = factories.ProductFactory()
        self.material_stock = factories.MaterialStockFactory(store=self.store, material=self.material_quantity.ingredient, current_capacity=500, max_capacity=1000)
